...
//
//  Created by vitalii on 2020-10-09.
//  Copyright © 2020 vitalii. All rights reserved.
//
//  Calculator App Part 2 - Basic Calculator Functions
//  Version: 2.0
//
...
//
//  This app is a basic calculator that has number buttons, operator buttons, decimal point button, backspace button, plus/minus button, equals button and clear button.
